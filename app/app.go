...
import (
	...
	v2 "github.com/Neutaro/Neutaro-Chain/app/upgrades/v2"
)
...
var (
	_ runtime.AppI            = (*NeutaroApp)(nil)
	_ servertypes.Application = (*NeutaroApp)(nil)
)
...
func (app *NeutaroApp) setAnteHandler(txConfig client.TxConfig, wasmConfig wasmtypes.WasmConfig, txCounterStoreKey storetypes.StoreKey) {
...
func (app *NeutaroApp) setPostHandler() {
...
func (app *NeutaroApp) Name() string { return app.BaseApp.Name() }
...
func (app *NeutaroApp) setupUpgradeStoreLoaders() {
...
// read more here: https://docs.cosmos.network/main/core/upgrade
func (app *NeutaroApp) setupUpgradeHandlers() {
