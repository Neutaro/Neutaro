...
// NewRootCmd creates a new root command for neutaro. It is called once in the main function.
...
func (a appCreator) appExport(
	...
	if height != -1 {
		if err := neutaroApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	}

	return neutaroApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs, modulesToExport)
}
